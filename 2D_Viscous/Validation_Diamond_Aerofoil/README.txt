Pseudo-transient viscous simulation (wall functions used) at Mach 1.7 for a 2D 10% thickness-chord aerofoil with zero angle of attack.

This case is setup and ready-to-run.

- To run this case in its current state: $ foamRun -solver shockFluid

To run this case in parallel (16 cores given as an example, ensure this matches numberOfSubdomains in system/decomposeParDict):
$ decomposePar
$ mpirun -np 16 foamRun -solver shockFluid -parallel
$ reconstructPar
