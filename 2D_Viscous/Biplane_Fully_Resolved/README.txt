...
To run this case in parallel (64 cores given as an example, ensure this matches numberOfSubdomains in system/decomposeParDict):
$ decomposePar
$ mpirun -np 64 foamRun -solver shockFluid -parallel
$ reconstructPar
