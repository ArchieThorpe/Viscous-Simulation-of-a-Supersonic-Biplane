// The unstructured mesh was made using .geo files provided by:
...
meshfactor = 0.05;//0.1 with farf 2;	//mesh scaling factor

hl = H/2-tl;//

//========================= OPTIMIZ. GEO VARIABLES

stag = -0*c;		//chords, Upper wing stagger (to left)
